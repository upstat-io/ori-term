...
- [ ] **Basic fullscreen exit (green button click):**
...
- [ ] **Basic fullscreen exit (keyboard shortcut):**
...
- [ ] **Focus change during fullscreen exit:**
...
- [ ] **Mission Control during fullscreen:**
  - Enter fullscreen
...
- [ ] **Fullscreen enter (regression check):**
  - Enter fullscreen
...
- [ ] **App launch in fullscreen (if supported):**
...
- [ ] **Window close during fullscreen exit:**
  - Enter fullscreen
...
- [ ] **Tab operations during fullscreen exit:**
...
- [ ] **macOS 26 (Tahoe) regression (if available):**
...
- [ ] All test matrix items verified (03.1)
- [ ] All edge cases verified (03.2)
- [ ] `./build-all.sh` green
- [ ] `./clippy-all.sh` green
- [ ] `./test-all.sh` green
