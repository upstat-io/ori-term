...
**Depends on:** Section 04 (framework). **Cross-validation note:** Section 06's status_reports scenarios should produce the same DA/DSR responses as the vttest menu6 tests — Section 09 verification will diff the two.
