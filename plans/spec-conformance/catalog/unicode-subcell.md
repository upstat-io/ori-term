...
| USC-LEGACY-QUADRANT | Unicode block (Symbols for Legacy Computing U+1FB00–U+1FB3B) | Printable Unicode chars U+1FB00..U+1FB3B (quadrants + sextants) | Quadrant + sextant subcell blocks | MISSING — to be added by Section 11 (Unicode Subcell Glyphs) | gpu-instance | parser:pending dispatch:pending state:pending frame-input:pending gpu:pending | missing | — | Pre-rewrite memory claimed these were implemented; 01.9 verifies. |
| USC-LEGACY-OCTANT | Unicode block (Symbols for Legacy Computing supplement U+1CC00–U+1CEFF) | Printable Unicode chars U+1CC00..U+1CEFF (octants) | Octant subcell blocks (Unicode 16) | MISSING — to be added by Section 11 (Unicode Subcell Glyphs) | gpu-instance | parser:pending dispatch:pending state:pending frame-input:pending gpu:pending | missing | — | Required for full notcurses-demo fidelity. |
