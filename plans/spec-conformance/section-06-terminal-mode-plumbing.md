...
success_criteria:
  ...
  - "Sync abort test: feed BSU + writes + advance virtual clock past timeout — assert Abort effect emitted, snapshot publishes the buffered writes (they are replayed, not discarded), snapshot_seqno advances by exactly 1"
