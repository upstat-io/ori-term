...
- [x] **Cross-compile smoke test**: after adding `windows` crate, run `cargo build --target x86_64-pc-windows-gnu` to confirm the new dependency links correctly under MinGW (verified 2026-04-04 — `./build-all.sh` passes clean)
