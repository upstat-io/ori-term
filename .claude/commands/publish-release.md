...
```
abc1234 feat(pty): add adaptive scrollback buffer
def5678 fix(renderer): resolve flickering on resize
ghi9012 perf(grid): optimize dirty-line tracking
jkl3456 docs: update installation guide
mno7890 chore(ci): update build matrix
```
...
### Bug Fixes
- Fix flickering on terminal resize

### Performance
- Optimize dirty-line tracking in grid renderer
```
