...
/// Regression: BUG-07-007 — helper walks menu 1 to completion, returning
...
/// Regression: BUG-07-007 — helper makes ZERO closure calls when the
...
/// Regression: BUG-07-007 — helper terminates after `max_screens`
/// closure invocations.
///
...
/// Regression: BUG-07-007 — helper passes the SAME `text` value to the
