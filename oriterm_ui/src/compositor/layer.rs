//! Core layer types for the compositor: `LayerId`, `LayerType`,
//! `LayerProperties`, and `Layer`.
//!
...
///
/// Generated by [`LayerTree`](super::layer_tree::LayerTree) via its internal
/// counter. Distinct from `WidgetId` — layers are compositor primitives,
/// not widget-tree nodes.
