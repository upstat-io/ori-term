...
//!
//! All icons use a 24×24 viewBox with `stroke-width="2"`.
...
pub static SIDEBAR_ICON_SOURCES: [SidebarIconSource; 8] = [
    SidebarIconSource {
        ...
        svg: r#"<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="5"/><path d="M12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42"/></svg>"#,
    },
    SidebarIconSource {
        id: IconId::Palette,
        logical_size: 16,
    ...
    SidebarIconSource {
        ...
        viewbox_size: 24.0,
        source_stroke_width: 2.0,
        svg: r#"<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 7V4h16v3M9 20h6M12 4v16"/></svg>"#,
    },
    SidebarIconSource {
        id: IconId::Terminal,
        logical_size: 16,
        viewbox_size: 24.0,
        source_stroke_width: 2.0,
        svg: r#"<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="4 17 10 11 4 5"/><line x1="12" y1="19" x2="20" y2="19"/></svg>"#,
    },
    SidebarIconSource {
        id: IconId::Keyboard,
        logical_size: 16,
        viewbox_size: 24.0,
        source_stroke_width: 2.0,
        svg: r#"<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="M6 8h.01M10 8h.01M14 8h.01M18 8h.01M8 12h.01M12 12h.01M16 12h.01M8 16h8"/></svg>"#,
    },
    SidebarIconSource {
        id: IconId::Window,
        logical_size: 16,
        viewbox_size: 24.0,
        source_stroke_width: 2.0,
        svg: r#"<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18"/></svg>"#,
    },
    SidebarIconSource {
        id: IconId::Bell,
        logical_size: 16,
        viewbox_size: 24.0,
        source_stroke_width: 2.0,
        svg: r#"<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 8A6 6 0 006 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 01-3.46 0"/></svg>"#,
    },
    SidebarIconSource {
        id: IconId::Activity,
        logical_size: 16,
        viewbox_size: 24.0,
        source_stroke_width: 2.0,
        svg: r#"<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>"#,
    },
];
