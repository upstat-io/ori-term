...
11. If findings cluster (5+ in one module), add a note: "Warning: Clustered findings suggest deeper design issue -- consider architectural review before proceeding"
