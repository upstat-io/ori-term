---
description: Stage, commit, and push all changes using conventional commit format
---
...
**Scope** is optional. Use the primary module affected (e.g., `grid`, `render`, `pty`, `selection`, `ui`).
