...
pub use term::{
    AceMode, DamageLine, KittyHandlerStats, KittySubstep, Notification, PromptMarker, PromptState,
    RenderableCell, RenderableContent, RenderableCursor, RenderableImageData, RenderablePlacement,
    Term, TermDamage, TermMode, encode_enter_base, maybe_shrink_vec,
};
pub use theme::Theme;
