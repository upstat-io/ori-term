...
//!
//! See BUG-08-12 (`plans/bug-tracker/fix-BUG-08-012.md`) for the full
...
impl<S: EffectSink> Term<S> {
    ...
    /// mutations on the inactive screen (BUG-08-12 TPR round-5).
    pub fn restore_keyboard_mode_stack(&mut self) {
        ...
        // the shell's prompt-boundary restore. BUG-08-12 TPR round-5.
