...
//! directory-module conversion (BUG-08-12). New toggle-reapply tests
//! pin the pre-existing DRIFT fix landed with BUG-08-12.
...
// --- New BUG-08-12 toggle_alt_common drift/paired-snapshot tests ---

/// Regression: BUG-08-12 — kitty keyboard mode bits leaked across
...
/// Regression: BUG-08-12 — empty alt stack left primary's KITTY bits
/// active after `?1049h`.
#[test]
...
/// Regression: BUG-08-12 — paired snapshot fields must swap alongside
